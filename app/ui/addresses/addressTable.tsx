            ...
            <tbody className="divide-y divide-gray-200 bg-white">
                {records.map((record) => (
                    <tr key={record.id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{record.city}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{record.state}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{record.zip}</td>
