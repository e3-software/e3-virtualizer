...
const navigation = [
  ...
  { name: "Import", href: "/e3/import", current: false },
          ...
          {navigation.map((item) => (
            <a
              ...
              className={clsx("rounded-md px-3 py-2 text-sm font-medium", {
                "bg-astral-900 className='dark:text-gray-300' text-white": pathname === item.href,
                "text-astral-300 hover:bg-astral-700 className='dark:text-gray-300' hover:text-white":
                  pathname !== item.href,
              })}
